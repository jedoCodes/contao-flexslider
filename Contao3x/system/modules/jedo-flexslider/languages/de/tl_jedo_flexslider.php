...
$GLOBALS['TL_LANG']['tl_jedo_flexslider']['nextText']= 'Weiter';
$GLOBALS['TL_LANG']['tl_jedo_flexslider']['prevText']= 'zur&uuml;ck';



// Secondary Navigation

$GLOBALS['TL_LANG']['tl_jedo_flexslider']['pauseText']= 'Pause';
$GLOBALS['TL_LANG']['tl_jedo_flexslider']['playText']= 'Abspielen';
